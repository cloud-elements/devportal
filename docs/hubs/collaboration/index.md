...
seo: Collaboration Hub Overview | Cloud Elements API Docs
title: Overview
...
## Collaboration Hub APIs

Hubs map resources from a collection of endpoints (What we call Elements) into a uniform set of APIs. With Hubs you can integrate an entire category of services (e.g., Collaboration, Documents, Finance) through a single set of APIs.
