...
You can authenticate with Infusionsoft o create your own instance of the {{page.heading}} element through the UI or through APIs. Once authenticated, you can use the element instance to access the different functionality offered by the Infusionsoft platform.
...
Use the UI to authenticate with Infusionsoft and create an element instance. {{page.heading}} authentication follows the typical OAuth 2.0 framework and you will need to sign in to Infusionsoft as part of the process.
...
6. In **Infusionsoft Server** enter the url of your Infusionsoft account. For example, if your url is `https://dt648.infusionsoft.com` enter `dt648.infusionsoft.com`.
7. In **Infusionsoft Encrypted Key** enter the Encrypted Key that you identified in [API Provider Setup](setup.html).
9. Optionally type or select one or more Element Instance Tags to add to the authenticated element instance.
7. Click **Create Instance**.
8. Provide your Infusionsoft credentials, and then allow the connection.
