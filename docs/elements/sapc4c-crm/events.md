...
| leads</br>`"event.poller.configuration": "{\"leads\"...}"`  | *Optional*</br>The {{page.heading}} `leads` resource available for polling.  |JSON object |
| opportunities</br>`"event.poller.configuration": "{\"opportunities\"...}"`  | *Optional*</br>The {{page.heading}} `opportunities` resource available for polling.  |JSON object |
