...
seo: Bulk APIs | Campaign Monitor | Cloud Elements API Docs
title: Bulk APIs
...
| :------------- | :------------- |
|  Bulk Type  |  Cloud Elements bulk service and not native bulk endpoints. Rate limits come into play when using the Cloud Elements bulk service, so review the limitations in the [service provider's documentation](https://www.campaignmonitor.com/api/getting-started/#rate-limiting).   |
| Upsert Support | Yes |
