...
seo: Authenticate | Freshbooks Cloud Accounting | Cloud Elements API Docs
title: Authenticate
...
6. In **Default Freshbooks Business Name** enter your Freshbooks Company Name.
...
{
"oauthUrl":
"https://my.freshbooks.com/service/auth/oauth/authorize?response_type=code&redirect_uri=https%3A%2F%2Fhttpbin.org%2Fget&state=freshbooksv2&client_id=l7xx1cf795a3144b42ac96cbb3f301af6b7b",
...
1. Construct a JSON body as shown below (see [Parameters](#parameters)):
    ...
    ```json
    {
      ...
      "configuration": {
        ...
        "business.name" : "<{{page.apiProvider}} Company Name>"
      },
      "tags": [
        "<Add_Your_Tag>"
      ],
...
| **Default Freshbooks Business Name**</br>`business.name`   | The Freshbooks Company Name  |  string |
...
```json
{
  ...
  "element": {
      "id": 10701,
      "name": "Freshbooks Cloud Accounting",
      "hookName": "Freshbooksv2",
      "key": "freshbooksv2",
