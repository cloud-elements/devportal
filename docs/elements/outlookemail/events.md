...
seo: Events | Outlook Email | Cloud Elements API Docs
title: Events
...
You can set up polling for the `messages` resource. You can also copy the `messages` configuration to poll other resources. See [Configure Polling Through API](#configure-polling-through-api) for more information.
    ...
    ```json
    {
      ...
      "configuration":{
        ...
        "event.poller.configuration":{
          "messages": {
              "url": "/hubs/general/messages?where=LastModifiedDateTime>='${gmtDate:yyyy-MM-dd'T'HH:mm:ss'Z'}'",
              "idField": "Id",
              "datesConfiguration": {
                "updatedDateField": "LastModifiedDateTime",
                "updatedDateFormat": "yyyy-MM-dd'T'HH:mm:ss'Z'",
                "updatedDateTimezone": "GMT",
                "createdDateField": "ReceivedDateTime",
