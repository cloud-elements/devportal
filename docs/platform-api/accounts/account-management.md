...
{% include callout.html content="The <i>Account Usage and Management Guide</i> is for Cloud Elements 1.0. Find Cloud Elements 2.0 documentation at <a href=../../guides/account-user-mgmt/index.html>Manage Accounts and Users</a>." type="info" %}
