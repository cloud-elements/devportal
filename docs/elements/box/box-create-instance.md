...
'https://api.cloud-your_moms.com/your_moms/api-v2/your_moms/box/oauth/url?apiKey=fake_Box_api_key&apiSecret=fake_Box_api_secret&callbackUrl=https://www.mycoolapp.com/auth&state=box'
```
