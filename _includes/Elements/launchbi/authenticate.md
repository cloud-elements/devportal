...
```json
{
"oauthUrl": "https://launchbi.launchworks.com/launchbi/OAuth2/authorize?response_type=code&redirect_uri=https://auth.cloudelements.io/oauth&state={{page.elementKey}}&client_id=Rand0MAP1-key",
...
```json
{
  ...
  "element": {
      ...
      "name": "{{page.heading}}",
      "key": "{{page.elementKey}}",
      "description": "Analytics Hub to access {{page.product}} through LaunchBI.",
      "image": "https://images.cloudelements.io/launchbi-logo201712291511.png",
      "active": true,
      "deleted": false,
      "typeOauth": false,
      "trialAccount": false,
