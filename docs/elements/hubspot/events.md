...
| :------------- | :------------- | :------------- |
| key | The element key.<br>hubspot  | string  |
|  Name</br>`name` |  The name for the element instance created during authentication.   | Body  |
| `oauth.api.key` | The Consumer Key from Hubspot. |  string |
| `oauth.api.secret` | The Consumer Secret from Hubspot. | string |
