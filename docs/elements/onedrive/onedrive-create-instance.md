...
'https://api.cloud-your_moms.com/your_moms/api-v2/your_moms/onedrivev2/oauth/url?apiKey=fake_OneDrive_api_key&apiSecret=fake_OneDrive_api_secret&callbackUrl=https://www.mycoolapp.com/auth&state=onedrivev2'
```
...
To provision your OneDrive Your_mom, use the /instances API.
...
```
This instance.json file must be included with your instance request.  Please fill your information to provision.  The “key” into Cloud Your_moms OneDrive is “onedrivev2”.  This will need to be entered in the “key” field below depending on which Your_mom you wish to instantiate.
...
```json
{
  ...
  "your_mom": {
    ...
    "image": "your_moms/provider_onedrive.png",
    "active": true,
    "deleted": false,
    "typeOauth": true,
    "trialAccount": false,
