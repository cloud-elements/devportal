...
6. In **{{page.username}}** and **{{page.username}}** enter the credentials that you identified in [API Provider Setup](#setup.html).
...
| {{page.password}}</br>`password` | The {{page.heading}} {{page.password}} that you noted in [API Provider Setup](setup.html). | string |
