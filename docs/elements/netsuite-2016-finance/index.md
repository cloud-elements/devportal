...
{{page.heading}} provides finance management services.
...
| :------------- | :------------- |
| API Documentation | [Netsuite Finance API documentation](http://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2016_2/schema/index.html) |
| Authentication | Token-Based or Basic: see the [setup guide](setup.html)  |
| Events | Webhooks and polling |
| Bulk | Supported for both upload and download. |
| Transformations | Supported. See [Define Common Resources and Transformations](/docs/guides/common-resources/index.html) for more information about transforming your {{page.heading}} data.|
| Rate Limits | [{{page.heading}} rate limit documentation](404.html)|
| Authentication Requirements |  A Netsuite 2016 Account required.|
