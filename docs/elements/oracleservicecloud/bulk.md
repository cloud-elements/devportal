...
seo: Bulk  | Oracle Service Cloud | Cloud Elements API Docs
title: Bulk
...
| :------------- | :------------- |
| Bulk Type  |  Oracle Cloud Service's native bulk functionality.  |
| Objects available   |  `Account`, `Incident`, `Contact` and `ServiceCategory` |
| Upsert Support | Yes |
