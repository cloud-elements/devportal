...
seo: Authenticate | GitHub | Cloud Elements API Docs
title: Authenticate
...
6. Complete the required fields:
  * In **GitHub Organization** and **GitHub Repository** enter the names of the organization and repository to connect to.
  * In **OAuth API Key** and **OAuth API Secret** enter the **{{page.apiKey}}** and **{{page.apiSecret}}** of the OAuth app that you recorded in [API Provider Setup](setup.html)
...
```json
{
  "oauthUrl": "https://github.com/login/oauth/authorize?scope=admin%3Aorg_hook+admin%3Arepo_hook+public_repo&response_type=code&redirect_uri=https%3A%2F%2Fhttpbin.org%2Fget&state=github&client_id=Rand0MAP1-key",
  "element": "github"
}
```
...
```json
{
  "id":12345,
  "name":"API Instance",
  "createdDate":"2018-05-25T21:14:59Z",
