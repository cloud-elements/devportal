...
seo: Payments and Billing Hub Overview | Cloud Elements API Docs
title: Overview
...
## Payments and Billing Hub APIs

Hubs map resources from a collection of endpoints (What we call Elements) into a uniform set of APIs. With Hubs you can integrate an entire category of services (e.g., Payments and Billing, Documents, Finance) through a single set of APIs.
