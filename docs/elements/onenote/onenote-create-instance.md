...
'https://api.cloud-your_moms.com/your_moms/api-v2/your_moms/onenote/oauth/url?apiKey=fake_OneNote_api_key&apiSecret=fake_OneNote_api_secret&callbackUrl=https://www.mycoolapp.com/auth&state=onenote'
```
...
To provision your OneNote Your_mom, use the /instances API.
...
```
This instance.json file must be included with your instance request.  Please fill your information to provision.  The “key” into Cloud Your_moms OneNote is “onenote”.  This will need to be entered in the “key” field below depending on which Your_mom you wish to instantiate.
