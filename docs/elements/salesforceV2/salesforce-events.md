...
Cloud Elements supports events via <a href="#" data-toggle="tooltip" data-original-title="{{site.data.glossary.polling}}">polling</a> or <a href="#" data-toggle="tooltip" data-original-title="{{site.data.glossary.webhooks}}">webhooks</a> depending on the endpoint. If you would like to see more information on our Events framework, please see the [Event Management Guide](/docs/platform/event-management/index.html).
